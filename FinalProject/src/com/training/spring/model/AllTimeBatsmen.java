...
public class AllTimeBatsmen {
	...
	public AllTimeBatsmen() {
	}

	public AllTimeBatsmen(int position, String player, String team, int innings, int runs, double average,
			double strikeRate, int hundreds, int fifties, int highScore) {
	...
	public String toString() {
		return "allTimeBatsmen [position=" + position + ", player=" + player + ", team=" + team + ", innings=" + innings
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AllTimeBatsmen other = (AllTimeBatsmen) obj;
